...
public class SegmentFileTest extends BaseStorageTest {
    ...
    public void setup() throws Exception {
        super.setup();
        this.writeExecutor = new ThreadPoolExecutor(8, 16,0L, TimeUnit.MILLISECONDS,new LinkedBlockingQueue<Runnable>());
    ...
    private boolean init() {
        SegmentFile.SegmentFileOptions opts = SegmentFile.SegmentFileOptions.builder() //
            .setRecover(false) //
            .setLastFile(true) //
            .setNewFile(true) //
            .setSync(true) //
    ...
    public void testWriteRead() throws Exception {
        ...
        assertEquals(firstWritePos, this.segmentFile.write(0, data));
        ...
        assertEquals(nextWrotePos, this.segmentFile.write(1, data2));
